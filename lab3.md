...
```
This command above will print all the files with the ".txt" extention that reside in find-results.txt The results of this command can be seen below:
...
written_2//non-fiction/OUP/Castro/ak.txt
...
written_2//travel_guides/berlitz1/HistoryJapan copy.txt
